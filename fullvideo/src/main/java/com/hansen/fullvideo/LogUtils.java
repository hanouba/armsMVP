...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = Utils.getApplicationContext()
                    .getPackageManager()
                    .getPackageInfo(Utils.getApplicationContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                mDefaultDir = Utils.getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = Utils.getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
