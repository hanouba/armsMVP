...
public class SplashActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.init(this);
        mDBHelper = DBHelper.getInstance(SplashActivity.this);
    ...
    private void createLocalData() {
        BigScreenBean bigScreenBean1 = new BigScreenBean(0,0,1,1,"cctv-1",0,"预案1");
        ...
        BigScreenBean bigScreenBean15 = new BigScreenBean(6,3,3,3,"cctv-7",4,"预案5");
        ...
        mDBHelper.insertOrReplace(bigScreenBean15);
