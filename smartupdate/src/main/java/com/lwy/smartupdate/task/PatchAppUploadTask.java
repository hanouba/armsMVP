    ...
    private void patchUpdate(String patchFilePath, String hash) {
        ...
        if (packageInfo != null) {
            ...
            if (!TextUtils.isEmpty(oldApkSource)) {
                mCurrentVersion++;
                ///storage/emulated/0/Android/data/com.lwy.appsmartupdate/files/update/1.00_1.01.patch
                ///data/app/com.lwy.appsmartupdate-1/base.apk
                ///storage/emulated/0/Android/data/com.lwy.appsmartupdate/files/update/
